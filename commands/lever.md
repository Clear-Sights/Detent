---
description: Lever status — is the rod latched, is the punchcard honest. Runs the deterministic status trace and relays it verbatim.
---

Run `python3 -m lever` from the plugin root (if that import fails, run it with
