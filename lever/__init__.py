"""Lever: a strictly passive, deterministic leverage layer for coding agents.

It never initiates an LLM call. It reads structural signal the harness already emits on every
hook event (documented, bounded, model-agnostic — see lever/contract.py) and, where the event
